...
def new_doc(doc_name: str) -> None:
    ...
    # 点击文档坐标
    com.click_string_in_window_region(region1, '文档')
    time.sleep(8)

    com.click_string_in_window("输入标题")
    time.sleep(4)

    # 输入文档标题
    fn.input_string(doc_name)
    fn.key_input('Return')
    time.sleep(4)
    ...
    # 检测新建文档的标题
    pos = com.get_string_coordinate_in_window(doc_name, fuzzy=True)
    assert pos != {}, f'未检测到{doc_name}'
