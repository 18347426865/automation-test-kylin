...
def new_mind(mind_name: str) -> None:
    """
    新建一个思维导图
     param1: 文件名称
    """
    ...
    # 点击思维导图坐标
    com.click_string_in_window_region(leftbar_region, '思维导图')
    time.sleep(6)

    # 点击"新建空白图"按钮
    region2 = [260, 120, 300, 300]
    com.click_string_in_window_region(region2, '新建空白图')
    time.sleep(8)

    # 点击标题位置
    region3 = [0, 43, 200, 150]
    com.click_string_in_window_region(region3, '未命名文件')
    time.sleep(4)

    # 输入文档的标题
    fn.input_string(mind_name)
    fn.key_input('Return')
    time.sleep(4)
    ...
    # 检测新建文档的标题
    pos = com.get_string_coordinate_in_window(mind_name, fuzzy=True)
    assert pos != {}, f'未检测到{mind_name}'
