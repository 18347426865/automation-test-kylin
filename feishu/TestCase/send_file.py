...
def send_file(chat_name: str, file_path: str) -> None:
    """
    发送文件
     param1: 聊天名称
     param2: 文件路径
    ...
    # 点击在弹出的展开区域点击本地文件按钮
    com.click_string_in_window_region(CN.unfold_region, '本地文件')
    time.sleep(2)

    # 在弹出的窗口中输入文件的路径
    fn.paste_string(file_path)
    time.sleep(2)
